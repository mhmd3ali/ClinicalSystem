...
namespace WinFormsApp1
{
    public class visit
    {
        ...
        public string reason, diagnosis, notes;

        public visit(int visit_id, int patient_id, string patient_name, int secretary_id, string secretary_name, int doctor_id, string doctor_name, DateTime date, string reason, string diagnosis, string notes)
        {
